...
export function SeasonStatsEditor({ season, onChange, onRemove }: SeasonStatsEditorProps) {
  ...
  const handleMatchCountChange = (mi: number, wi: number, val: number, month: MonthlyStat, week: WeeklyStat) => {
    setMonths(ms =>
      ms.map((m, i) => i === mi ? {
        ...m,
                                ...
                                <div className="flex items-end gap-3">
                                  <div className="flex-1">
                                    ...
                                    <input
                                      ...
                                      max={20}
                                      value={w.matches}
                                      onChange={e => handleMatchCountChange(mi, wi, parseInt(e.target.value) || 0, mo, w)}
